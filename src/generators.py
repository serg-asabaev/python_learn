...
def filter_by_currency(input_list: list, currency: str) -> dict:
...
def transaction_descriptions(input_list: list):
...
def card_number_generator(beg_number: int = 0, end_number: int = 0):
    """
